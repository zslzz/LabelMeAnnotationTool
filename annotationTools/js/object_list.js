...
function RenderObjectList() {
    ...
    html_str += '<p style="font-size:10px;line-height:100%"><a id="submit_all_button" href="javascript:submit_all_answer();">Submit all polygons</a></p>';
