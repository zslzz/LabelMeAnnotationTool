...
function annotation(anno_id) {
    ...
    this.DrawPolygon = function (im_ratio, xp, yp) {
        ...
        if (xp.length == 1) {
            ...
            this.polygon_id = DrawPolyLine(this.div_attach, xp, yp, obj_name, 'none', HashObjectColor(obj_name), 4, "", im_ratio);
        }
            ...
            this.polygon_id = DrawPolygon(this.div_attach, xp, yp, obj_name, 'none', HashObjectColor(obj_name), 4, "9,5", im_ratio);
        }
        else {
            // Draw a polygon:
            // var attr = 'fill="none" stroke="' + HashObjectColor(obj_name) + '" stroke-width="4"';
            this.polygon_id = DrawPolygon(this.div_attach, xp, yp, obj_name, 'none', HashObjectColor(obj_name), 4, "", im_ratio);
        }
    ...
    this.DrawPolyLine = function (xp, yp) {
        ...
        this.point_id = DrawPoint(this.div_attach, xp[0], yp[0], 6, "#00ff00", "#ffffff", 3, im_ratio);
